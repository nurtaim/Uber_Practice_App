package com.Nurtai.BookMyRide.Customer;
...
import com.Nurtai.BookMyRide.HistoryActivity;
import com.Nurtai.BookMyRide.Login.LauncherActivity;
import com.Nurtai.BookMyRide.R;
...
public class CustomerMapActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(com.Nurtai.BookMyRide.R.id.map);
        mapFragment.getMapAsync(this);

        destinationLatLng = new LatLng(0.0,0.0);

        mDriverInfo = findViewById(com.Nurtai.BookMyRide.R.id.driverInfo);
        mRadioLayout = findViewById(R.id.radioLayout);

        mDriverProfileImage = findViewById(com.Nurtai.BookMyRide.R.id.driverProfileImage);

        mDriverName = findViewById(com.Nurtai.BookMyRide.R.id.driverName);
        mDriverPhone = findViewById(com.Nurtai.BookMyRide.R.id.driverPhone);
        mDriverCar = findViewById(com.Nurtai.BookMyRide.R.id.driverCar);
        ...
        mRequest = findViewById(com.Nurtai.BookMyRide.R.id.request);
            ...
            public void onClick(View v) {
                ...
                if (requestBol){
                   ...
                   switch (selectId){
                    ...
                    pickupMarker = mMap.addMarker(new MarkerOptions().position(pickupLocation).title("Pickup Here").icon(BitmapDescriptorFactory.fromResource(com.Nurtai.BookMyRide.R.mipmap.ic_pickup)));
        ...
        driverLocationRefListener = driverLocationRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && requestBol){
                    ...
                    mDriverMarker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("your driver").icon(BitmapDescriptorFactory.fromResource(com.Nurtai.BookMyRide.R.mipmap.ic_car)));
                }
    ...
    private void endRide(){
        ...
        mDriverProfileImage.setImageResource(com.Nurtai.BookMyRide.R.mipmap.ic_default_user);
    }
